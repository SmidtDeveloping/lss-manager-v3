...
if (I18n.locale == 'en_US') {
    ...
    lssm.carsById = {
        ...
        84: ['Pump Trailer', 0],
        85: ['Control Van', 4],
        86: ['Operational Support Van', 4],
        87: ['Operational Support Trailer', 4],
        88: ['SAR Flood Rescue (Trailer)', 4],
        89: ['Drone Vehicle (SAR HQ)', 4],
        90: ['Drone Vehicle (Fire Station)', 0],
        91: ['Drone Vehicle (Police Station)', 2],
        92: ['Personal SAR Vehicle', 4],
        93: ['SAR 4x4', 4],
        94: ['RRV', 1],
    ...
    lssm.carsById = {
        ...
        12: [
            'TST-NB 8/9 | Tankautospuit Natuurbrandbestrijding (8/9 personen)',
            0,
        ],
        13: ['TS8 (4x4)', 0],
        14: [
            'TST-NB 6/7 | Tankautospuit Natuurbrandbestrijding (6/7 personen)',
            0,
        ],
        15: [
            'TST-NB 4/5 | Tankautospuit Natuurbrandbestrijding (4 personen)',
            0,
        ],
        16: ['Ambulance', 1],
        ...
        57: [
            'DA OVDG-RR | Dienstvoertuig Officier van Dienst-Geneeskundig/Rapid Responder',
            1,
        ],
...
lssm.car_list = function (building) {
    ...
    $.each(lssm.vehicles, function (vid, car) {
        if (car.building != building) return true;
        data.push({
            id: vid,
            name: car.name,
            type: car.type,
...
lssm.car_list_printable = function (list) {
    ...
    $.each(list, function (key, car) {
        data +=
            '<div style="margin-top: 3px;"><span class="building_list_fms building_list_fms_' +
            car.fms_real +
            '">' +
            car.fms_show +
            '</span> ' +
...
lssm.newDragableDivOnMap = function (id, classe, pos) {
    ...
    info.onAdd = function () {
        ...
        L.DomUtil.setPosition(
            info._div,
            new L.Point(changeX(pos.x, m.x), changeY(pos.y, m.y))
        );
        this.update();
        return this._div;
    };
